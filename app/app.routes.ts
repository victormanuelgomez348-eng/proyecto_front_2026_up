...
export const routes: Routes = [
  ...
  // 2. RUTAS PROTEGIDAS
  { path: 'beneficiarios', component: BeneficiarioComponent, canActivate: [authGuard], data: { roles: ['admin', 'docente'] } },
  { path: 'indicadores', component: IndicadorComponent, canActivate: [authGuard], data: { roles: ['admin', 'docente'] } },
  { path: 'seguimientos', component: SeguimientoComponent, canActivate: [authGuard], data: { roles: ['admin', 'docente'] } },
  { path: 'servicios-prestados', component: ServicioPrestadoComponent, canActivate: [authGuard], data: { roles: ['admin', 'docente', 'estudiante'] } },
